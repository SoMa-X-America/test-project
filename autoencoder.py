...
fname='DegreeVector_8lrKv75pdy4.txt'
degreedata = load_data_file2(fname, num_flds=10+1,num=240)
...
print('줄수',linenum-1)
'''
mnist = degreedata.reshape(linenum-1,10,1)
degreedata.reshape(linenum-1,10,1)
learning_rate=0.001
total_epoch=30
batch_size=128
...
total_batch=int(linenum/batch_size)
...
for epoch in range(total_epoch):
    ...
    for i in range(total_batch):
        batch_xs=degreedata
        batch_ys=degreedata
        batch_xs,batch_ys=next_batch(batch_size,batch_xs,batch_ys)
...
for epoch in range(training_epoch):
    ...
    for i in range(int(total_batch/2400)):
