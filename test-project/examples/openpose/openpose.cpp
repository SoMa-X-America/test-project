...
DEFINE_double(camera_fps,               10.0,           "Frame rate for the webcam (only used when saving video from webcam). Set this value to the"
...
DEFINE_string(write_images_format,      "",          "File extension and format for `write_images`, e.g. png, jpg or bmp. Check the OpenCV"
